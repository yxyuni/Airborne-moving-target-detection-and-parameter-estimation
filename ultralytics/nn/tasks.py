...
import sys
sys.path.append(r'/home/oper/dxy/yolov10/ultralytics')
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in {
            ...
            args = [c1, c2, *args[1:]]
            if m in (BottleneckCSP, C1, C2, C2f, C2fAttn, C3, C3TR, C3Ghost, C3x, RepC3, C2fCIB, MSFM, C3k2, C2PSA):
            ...
            args = [ch[f], *args]
            # c2 = ch[f]
        elif m in {InceptionDWConv2d, CBAM, MetaNeXtBlock, FeaturePartitionAttention}:
            args = [ch[f], *args]
            c2 = ch[f]
        elif m in {Add}:
            args = [ch[f[0]], *args]
...
if __name__ == '__main__':
    net = DetectionModel()
    print(net)
    input_rgb = torch.Tensor(8, 3, 256, 256)
    ...
    # yaml_path = r'/home/oper/dxy/yolov10/my_yolo/my_yolov8.yaml'
    # DetectionModel(cfg=yaml_path,nc=1)
